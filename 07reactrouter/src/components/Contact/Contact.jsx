      ...
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <form className="p-6 bg-gray-50 sm:rounded-lg shadow-md flex flex-col justify-center space-y-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-full py-3 px-4 rounded-lg bg-white border border-gray-300 text-gray-800 font-semibold focus:ring-2 focus:ring-orange-500 focus:outline-none"
                />
              </div>
              ...
              <div className="flex flex-col">
                <label htmlFor="tel" className="text-sm text-gray-600 mb-2">
                  Telephone Number
                </label>
                <input
                  type="tel"
